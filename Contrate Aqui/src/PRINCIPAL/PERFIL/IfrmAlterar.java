...
public class IfrmAlterar extends javax.swing.JInternalFrame {

    private static IfrmAlterar ifrmAlterar;
    private int idUser;
    private String tipo;
    ...
    private JAprendiz jap = new JAprendiz();
    ...
    public static IfrmAlterar getInstance() {
        if (ifrmAlterar == null) {
            ifrmAlterar = new IfrmAlterar();
        }
        return ifrmAlterar;
    }
    ...
    private void initComponents() {
        ...
        scrPainelAlterar = new javax.swing.JScrollPane();
        ...
        setPreferredSize(new java.awt.Dimension(296, 1000));
        ...
        scrPainelAlterar.setPreferredSize(new java.awt.Dimension(202, 1200));

        pnlAlterar.setBackground(new java.awt.Color(0, 0, 0));
        pnlAlterar.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Meus Dados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 15), new java.awt.Color(255, 255, 255))); // NOI18N
        pnlAlterar.setForeground(new java.awt.Color(255, 255, 255));
        pnlAlterar.setPreferredSize(new java.awt.Dimension(200, 900));
        ...
        btnAlterar.setText("Salvar dados");
                    ...
                    .addGroup(pnlAlterarLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlAlterarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlAlterarLayout.createSequentialGroup()
                                ...
                                .addComponent(cbxEdita, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlAlterarLayout.createSequentialGroup()
                            ...
                            .addGroup(pnlAlterarLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbxEstagio, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlAlterarLayout.createSequentialGroup()
                                .addGap(84, 84, 84)
                                .addComponent(lblBio))
        ...
        scrPainelAlterar.setViewportView(pnlAlterar);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(scrPainelAlterar, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(scrPainelAlterar, javax.swing.GroupLayout.PREFERRED_SIZE, 866, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            if (!vazio()) {
                setarDados();
                meUser.alterar(user, aut, col, emp, jap, idUser, tipo);
            }
        } catch (RuntimeException err) {
            JOptionPane.showMessageDialog(null, "Verifique seus dados!", "Erro na alteração", JOptionPane.ERROR_MESSAGE);
            throw new RuntimeException("Erro no alterar IfrmAlterar: " + err);
        }
    ...
    private void setarDados() {
        ...
        switch (tipo) {
            case "Autônomo":
                user.setCpfUser(txtFormatado.getText());
                user.setNomeUser(txtNome.getText());
                user.setTelefoneUser(txtTelefone.getText());
                user.setEmailUser(txtEmail.getText());
                user.setEstadoUser(cbxEstado.getSelectedItem().toString());
                user.setCidadeUser(txtCidade.getText());
                user.setBairroUser(txtBairro.getText());
                user.setDataUser(data);
                user.setFilhoUser(txtFilho.getText());
                user.setBioUser(txtBio.getText());

                aut.setProfissaoAutonomo(txtEdita1.getText());
                break;
            ...
            case "Colaborador":
                ...
                col.setAreaColaborador(txtEdita1.getText());
                col.setSituacaoColaborador(cbxEdita.getSelectedItem().toString());
                break;

            case "Empresa":
                user.setCnpjUser(txtFormatado.getText());
                user.setNomeUser(txtNome.getText());
                user.setTelefoneUser(txtTelefone.getText());
                user.setEmailUser(txtEmail.getText());
                user.setEstadoUser(cbxEstado.getSelectedItem().toString());
                ...
                emp.setTrabalhoEmpresa(txtEdita1.getText());
                emp.setEstagioEmpresa(cbxEstagio.getSelectedItem().toString());
                break;
            ...
            case "Jovem Aprendiz":
                ...
                jap.setInstituicaoAprendiz(txtEdita2.getText());
                jap.setAreaAprendiz(txtEdita1.getText());
                break;
        }
    }
    ...
    private boolean vazio() {
        ...
        switch (tipo) {
            case "Autônomo":
                if (txtFormatado.getText().equals("   .   .   -  ")
                        || txtEmail.getText().equals("")
                        || txtNome.getText().equals("")) {
                    JOptionPane.showMessageDialog(null,
                            "Há campos que devem ser preenchidos", "Campos vazios!",
    ...
    private javax.swing.JScrollPane scrPainelAlterar;
